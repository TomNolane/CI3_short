...
else
{
    ...
    $description = 'Pleniadzeskybko - najlepszy w internecie serwis w udzielaniu błyskawicznych pożyczek i kredytów bez sprawdzania historii kredytowej.Tylko u nas najlepsze oferty kredytowe!';
    require 'header.php'; 
